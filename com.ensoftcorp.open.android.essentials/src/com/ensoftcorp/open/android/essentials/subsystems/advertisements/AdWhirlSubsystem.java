 ...
 * @author Ben Holland
 */
public class AdWhirlSubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "AD_WHIRL_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.adwhirl");
	}
