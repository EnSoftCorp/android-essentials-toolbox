 ...
 * @author Ben Holland
 */
public class AdMarvelSubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "AD_MARVEL_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.admarvel");
	}
