 ...
 * @author Ben Holland
 */
public class SponsorPaySubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "SPONSOR_PAY_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.sponsorpay");
	}
