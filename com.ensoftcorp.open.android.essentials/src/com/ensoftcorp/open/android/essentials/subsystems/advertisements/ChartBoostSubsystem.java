 ...
 * @author Ben Holland
 */
public class ChartBoostSubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "CHART_BOOST_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.chartboost");
	}
