 ...
 * @author Ben Holland
 */
public class MedialetsSubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "MEDIALETS_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.medialets");
	}
