 ...
 * @author Ben Holland
 */
public class AppLovinSubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "APP_LOVIN_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.applovin");
	}
