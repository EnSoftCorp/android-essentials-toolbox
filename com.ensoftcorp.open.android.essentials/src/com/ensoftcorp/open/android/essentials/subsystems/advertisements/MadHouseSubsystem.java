 ...
 * @author Ben Holland
 */
public class MadHouseSubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "MAD_HOUSE_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.madhouse");
	}
