 ...
 * @author Ben Holland
 */
public class GreyStripeSubsystem extends AndroidAdvertisementSubsystem {

	public static final String TAG = "GREY_STRIPE_SUBSYSTEM";
	...
	public String[] getNamespaces() {
		return getNestedPackages("com.greystripe");
	}
