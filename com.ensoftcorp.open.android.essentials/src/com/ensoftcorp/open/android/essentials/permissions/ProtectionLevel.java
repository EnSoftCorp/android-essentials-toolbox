...
public class ProtectionLevel {
	...
	// more or less undocumented permission levels
	...
	static {
		...
		DANGEROUS.permissions.add(Permission.READ_PRECISE_PHONE_STATE);
		...
		DANGEROUS.permissions.add(Permission.GET_TASKS);
		...
		SIGNATURE.permissions.add(Permission.BIND_CALL_SERVICE);
		...
		SIGNATURE.permissions.add(Permission.RETRIEVE_WINDOW_INFO);
		...
		SIGNATURE.permissions.add(Permission.MARK_NETWORK_SOCKET);
		...
		SIGNATURE.permissions.add(Permission.MAGNIFY_DISPLAY);
		...
		SYSTEM.permissions.add(Permission.PACKAGE_USAGE_STATS);
		...
		SYSTEM.permissions.add(Permission.BIND_CALL_SERVICE);
		...
		SYSTEM.permissions.add(Permission.MARK_NETWORK_SOCKET);
		...
		// SIGNATURE_OR_SYSTEM is UPDATE_LOCK plus the union of SIGNATURE and SYSTEM
		SIGNATURE_OR_SYSTEM.permissions.add(Permission.UPDATE_LOCK);
		SIGNATURE_OR_SYSTEM.permissions.addAll(SIGNATURE.getPermissions());
		SIGNATURE_OR_SYSTEM.permissions.addAll(SYSTEM.getPermissions());
	}
