...
public class Permission {
	...
	public static final Permission PROVIDE_TRUST_AGENT = new Permission("android.permission.PROVIDE_TRUST_AGENT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to provide a trust agent. For security reasons, this is a platform-only permission.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_WIMAX_STATE = new Permission("android.permission.ACCESS_WIMAX_STATE", -1, -1, "No description provided.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ASEC_ACCESS = new Permission("android.permission.ASEC_ACCESS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows access to ASEC non-destructive API calls", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MODIFY_PARENTAL_CONTROLS = new Permission("android.permission.MODIFY_PARENTAL_CONTROLS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to modify parental controls <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_INCALL_SERVICE = new Permission("android.permission.BIND_INCALL_SERVICE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to bind to InCallService implementations.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_ALL_EXTERNAL_STORAGE = new Permission("android.permission.ACCESS_ALL_EXTERNAL_STORAGE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to access all multi-user external storage", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CAMERA_DISABLE_TRANSMIT_LED = new Permission("android.permission.CAMERA_DISABLE_TRANSMIT_LED", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows disabling the transmit-indicator LED that is normally on when a camera is in use by an application.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission READ_SEARCH_INDEXABLES = new Permission("android.permission.READ_SEARCH_INDEXABLES", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nInternal permission to allows an application to read indexable data.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CHANGE_BACKGROUND_DATA_SETTING = new Permission("android.permission.CHANGE_BACKGROUND_DATA_SETTING", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows applications to change the background data setting. <p>Not for use by third-party applications. pending API council", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CAPTURE_TV_INPUT = new Permission("android.permission.CAPTURE_TV_INPUT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows to capture a frame of TV input hardware such as built-in tuners and HDMI-in's. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission GET_DETAILED_TASKS = new Permission("android.permission.GET_DETAILED_TASKS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to get full detailed information about recently running tasks, with full fidelity to the real state.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission WRITE_MEDIA_STORAGE = new Permission("android.permission.WRITE_MEDIA_STORAGE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to write to internal media storage", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MOVE_PACKAGE = new Permission("android.permission.MOVE_PACKAGE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to move location of installed package.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission LAUNCH_TRUST_AGENT_SETTINGS = new Permission("android.permission.LAUNCH_TRUST_AGENT_SETTINGS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to launch the trust agent settings activity.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission RECOVERY = new Permission("android.permission.RECOVERY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to do certain operations needed for interacting with the recovery (system update) system.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission FORCE_STOP_PACKAGES = new Permission("android.permission.FORCE_STOP_PACKAGES", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to call {android.app.ActivityManager#forceStopPackage}.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission GLOBAL_SEARCH_CONTROL = new Permission("android.permission.GLOBAL_SEARCH_CONTROL", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nInternal permission protecting access to the global search system: ensures that only the system can access the provider to perform queries (since this otherwise provides unrestricted access to a variety of content providers), and to write the search statistics (to keep applications from gaming the source ranking).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CONTROL_WIFI_DISPLAY = new Permission("android.permission.CONTROL_WIFI_DISPLAY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to control low-level features of Wifi displays such as opening an RTSP socket. This permission should only be used by the display manager.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission READ_PRECISE_PHONE_STATE = new Permission("android.permission.READ_PRECISE_PHONE_STATE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows read only access to precise phone state. Pending API council approval", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission FRAME_STATS = new Permission("android.permission.FRAME_STATS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to collect frame statistics", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission WRITE_DREAM_STATE = new Permission("android.permission.WRITE_DREAM_STATE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows applications to write dream settings, and start or stop dreaming.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_ACTIVITY_STACKS = new Permission("android.permission.MANAGE_ACTIVITY_STACKS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to create/manage/remove stacks", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission NET_TUNNELING = new Permission("android.permission.NET_TUNNELING", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows low-level access to tun tap driver", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission START_ANY_ACTIVITY = new Permission("android.permission.START_ANY_ACTIVITY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to start any activity, regardless of permission protection or exported state.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission FILTER_EVENTS = new Permission("android.permission.FILTER_EVENTS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to register an input filter which filters the stream of user events (keys, touch, trackball) before they are dispatched to any window.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission START_TASKS_FROM_RECENTS = new Permission("android.permission.START_TASKS_FROM_RECENTS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to start a task from a ActivityManager#RecentTaskInfo.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission STOP_APP_SWITCHES = new Permission("android.permission.STOP_APP_SWITCHES", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to tell the activity manager to temporarily stop application switches, putting it into a special mode that prevents applications from immediately switching away from some critical UI such as the home screen.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission SET_KEYBOARD_LAYOUT = new Permission("android.permission.SET_KEYBOARD_LAYOUT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows low-level access to setting the keyboard layout. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BLUETOOTH_STACK = new Permission("android.permission.BLUETOOTH_STACK", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows bluetooth stack to access files This should only be used by Bluetooth apk.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ASEC_CREATE = new Permission("android.permission.ASEC_CREATE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows creation of ASEC volumes", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission RECEIVE_EMERGENCY_BROADCAST = new Permission("android.permission.RECEIVE_EMERGENCY_BROADCAST", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to receive emergency cell broadcast messages, to record or display them to the user. <p>Not for use by third-party applications. Pending API council approval", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_INPUT_FLINGER = new Permission("android.permission.ACCESS_INPUT_FLINGER", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to use InputFlinger's low level features.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_PACKAGE_VERIFIER = new Permission("android.permission.BIND_PACKAGE_VERIFIER", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nMust be required by package verifier receiver, to ensure that only the system can interact with it.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_KEYGUARD_SECURE_STORAGE = new Permission("android.permission.ACCESS_KEYGUARD_SECURE_STORAGE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows access to keyguard secure storage. Only allowed for system processes.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission COPY_PROTECTED_DATA = new Permission("android.permission.COPY_PROTECTED_DATA", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nMust be required by default container service so that only the system can bind to it and use it to copy protected data to secure containers or files accessible to the system.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ASEC_RENAME = new Permission("android.permission.ASEC_RENAME", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows rename of ASEC volumes", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission RETRIEVE_WINDOW_TOKEN = new Permission("android.permission.RETRIEVE_WINDOW_TOKEN", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to retrieve the window token from the accessibility manager.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission REMOTE_AUDIO_PLAYBACK = new Permission("android.permission.REMOTE_AUDIO_PLAYBACK", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows registration for remote audio playback.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MODIFY_NETWORK_ACCOUNTING = new Permission("android.permission.MODIFY_NETWORK_ACCOUNTING", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to account its network traffic against other UIDs. Used by system services like download manager and media server. Not for use by third party apps.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission READ_NETWORK_USAGE_HISTORY = new Permission("android.permission.READ_NETWORK_USAGE_HISTORY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to read historical network usage for specific networks and applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission REMOVE_DRM_CERTIFICATES = new Permission("android.permission.REMOVE_DRM_CERTIFICATES", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to remove DRM certificates This is not a third-party API (intended for system apps).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_USERS = new Permission("android.permission.MANAGE_USERS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to call APIs that allow it to query and manage users on the device. This permission is not available to third party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MODIFY_AUDIO_ROUTING = new Permission("android.permission.MODIFY_AUDIO_ROUTING", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to modify audio routing and override policy decisions. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission UPDATE_APP_OPS_STATS = new Permission("android.permission.UPDATE_APP_OPS_STATS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to update application operation statistics. Not for use by third party apps.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission READ_INSTALL_SESSIONS = new Permission("android.permission.READ_INSTALL_SESSIONS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to read install sessions This is not a third-party API (intended for system apps).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission UPDATE_LOCK = new Permission("android.permission.UPDATE_LOCK", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to hold an UpdateLock, recommending that a headless OTA reboot *not* occur while the lock is held.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CONFIRM_FULL_BACKUP = new Permission("android.permission.CONFIRM_FULL_BACKUP", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows a package to launch the secure full-backup confirmation UI. ONLY the system process may hold this permission.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission PACKAGE_USAGE_STATS = new Permission("android.permission.PACKAGE_USAGE_STATS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to collect component usage statistics", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CONTROL_KEYGUARD = new Permission("android.permission.CONTROL_KEYGUARD", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to control keyguard. Only allowed for system processes.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission TRUST_LISTENER = new Permission("android.permission.TRUST_LISTENER", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to listen to trust changes. Only allowed for system processes.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission PACKAGE_VERIFICATION_AGENT = new Permission("android.permission.PACKAGE_VERIFICATION_AGENT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nPackage verifier needs to have this permission before the PackageManager will trust it to verify packages.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission C2D_MESSAGE = new Permission("android.intent.category.MASTER_CLEAR.permission.C2D_MESSAGE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nC2DM permission. Used internally.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission RECEIVE_BLUETOOTH_MAP = new Permission("android.permission.RECEIVE_BLUETOOTH_MAP", -1, -1, "No description provided.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_REMOTE_DISPLAY = new Permission("android.permission.BIND_REMOTE_DISPLAY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nMust be required by a {com.android.media.remotedisplay.RemoteDisplayProvider}, to ensure that only the system can bind to it.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ALLOW_ANY_CODEC_FOR_PLAYBACK = new Permission("android.permission.ALLOW_ANY_CODEC_FOR_PLAYBACK", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to use any media decoder when decoding for playback", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_JOB_SERVICE = new Permission("android.permission.BIND_JOB_SERVICE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows the system to bind to an application's task services", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission GRANT_REVOKE_PERMISSIONS = new Permission("android.permission.GRANT_REVOKE_PERMISSIONS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to grant or revoke specific permissions.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_DRM_CERTIFICATES = new Permission("android.permission.ACCESS_DRM_CERTIFICATES", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to provision and access DRM certificates This is not a third-party API (intended for system apps).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission READ_WIFI_CREDENTIAL = new Permission("android.permission.READ_WIFI_CREDENTIAL", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows applications to read Wi-Fi credential. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission TV_INPUT_HARDWARE = new Permission("android.permission.TV_INPUT_HARDWARE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows TvInputService to access underlying TV input hardware such as built-in tuners and HDMI-in's. This should only be used by OEM's TvInputService's.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission GET_APP_OPS_STATS = new Permission("android.permission.GET_APP_OPS_STATS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to collect battery statistics", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_KEYGUARD_APPWIDGET = new Permission("android.permission.BIND_KEYGUARD_APPWIDGET", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nPrivate permission, to restrict who can bring up a dialog to add a new keyguard widget", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MODIFY_APPWIDGET_BIND_PERMISSIONS = new Permission("android.permission.MODIFY_APPWIDGET_BIND_PERMISSIONS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nInternal permission allowing an application to query/set which applications can bind AppWidgets.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ASEC_MOUNT_UNMOUNT = new Permission("android.permission.ASEC_MOUNT_UNMOUNT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows mount / unmount of ASEC volumes", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_VOICE_KEYPHRASES = new Permission("android.permission.MANAGE_VOICE_KEYPHRASES", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nMust be required by hotword enrollment application, to ensure that only the system can interact with it. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_MEDIA_PROJECTION = new Permission("android.permission.MANAGE_MEDIA_PROJECTION", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nApi Allows an application to manage media projection sessions. This is not a third-party API (intended for system apps).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission OEM_UNLOCK_STATE = new Permission("android.permission.OEM_UNLOCK_STATE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows enabling/disabling OEM unlock <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission SHUTDOWN = new Permission("android.permission.SHUTDOWN", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to call the activity manager shutdown() API to put the higher-level system there into a shutdown state.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission SET_SCREEN_COMPATIBILITY = new Permission("android.permission.SET_SCREEN_COMPATIBILITY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nChange the screen compatibility mode of applications", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission SERIAL_PORT = new Permission("android.permission.SERIAL_PORT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows applications to access serial ports via the SerialManager.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_DIRECTORY_SEARCH = new Permission("android.permission.BIND_DIRECTORY_SEARCH", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to execute contacts directory search. This should only be used by ContactsProvider. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CONFIGURE_WIFI_DISPLAY = new Permission("android.permission.CONFIGURE_WIFI_DISPLAY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to configure and connect to Wifi displays", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CONTROL_INCALL_EXPERIENCE = new Permission("android.permission.CONTROL_INCALL_EXPERIENCE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to control the in-call experience.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CRYPT_KEEPER = new Permission("android.permission.CRYPT_KEEPER", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nInternal permission protecting access to the encryption methods", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission SCORE_NETWORKS = new Permission("android.permission.SCORE_NETWORKS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nTODO: Change protection level to normal when unhiding this API.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_CACHE_FILESYSTEM = new Permission("android.permission.ACCESS_CACHE_FILESYSTEM", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllow an application to read and write the cache partition.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BLUETOOTH_MAP = new Permission("android.permission.BLUETOOTH_MAP", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nControl access to email providers exclusively for Bluetooth", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_USB = new Permission("android.permission.MANAGE_USB", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to manage preferences and permissions for USB devices", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CHANGE_WIMAX_STATE = new Permission("android.permission.CHANGE_WIMAX_STATE", -1, -1, "No description provided.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission SET_WALLPAPER_COMPONENT = new Permission("android.permission.SET_WALLPAPER_COMPONENT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows applications to set a live wallpaper. XXX Change to signature once the picker is moved to its own apk as Ghod Intended.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_NETWORK_CONDITIONS = new Permission("android.permission.ACCESS_NETWORK_CONDITIONS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to listen for network condition observations. This is not a third-party API (intended for system apps).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission READ_PRIVILEGED_PHONE_STATE = new Permission("android.permission.READ_PRIVILEGED_PHONE_STATE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows read access to privileged phone state. Used internally.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission INTERACT_ACROSS_USERS = new Permission("android.permission.INTERACT_ACROSS_USERS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to call APIs that allow it to do interactions across the users on the device, using singleton services and user-targeted broadcasts. This permission is not available to third party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ASEC_DESTROY = new Permission("android.permission.ASEC_DESTROY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows destruction of ASEC volumes", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission INVOKE_CARRIER_SETUP = new Permission("android.permission.INVOKE_CARRIER_SETUP", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to call into a carrier setup flow. It is up to the carrier setup application to enforce that this permission is required This is not a third-party API (intended for OEMs and system apps).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission RECEIVE_DATA_ACTIVITY_CHANGE = new Permission("android.permission.RECEIVE_DATA_ACTIVITY_CHANGE", -1, -1, "No description provided.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission RETRIEVE_WINDOW_CONTENT = new Permission("android.permission.RETRIEVE_WINDOW_CONTENT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to retrieve the content of the active window An active window is the window that has fired an accessibility event.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_NOTIFICATIONS = new Permission("android.permission.ACCESS_NOTIFICATIONS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to read the current set of notifications, including any metadata and intents attached.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BACKUP = new Permission("android.permission.BACKUP", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to control the backup and restore process. <p>Not for use by third-party applications. pending API council", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission STATUS_BAR_SERVICE = new Permission("android.permission.STATUS_BAR_SERVICE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to be the status bar. Currently used only by SystemUI.apk", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission NFC_HANDOVER_STATUS = new Permission("android.permission.NFC_HANDOVER_STATUS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows sending and receiving handover transfer status from Wifi and Bluetooth", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CONNECTIVITY_INTERNAL = new Permission("android.permission.CONNECTIVITY_INTERNAL", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an internal user to use privileged ConnectivityManager APIs.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_DEVICE_ADMINS = new Permission("android.permission.MANAGE_DEVICE_ADMINS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nRequired to add or remove another application as a device admin. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission PERFORM_CDMA_PROVISIONING = new Permission("android.permission.PERFORM_CDMA_PROVISIONING", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to perform CDMA OTA provisioning", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission CAPTURE_AUDIO_HOTWORD = new Permission("android.permission.CAPTURE_AUDIO_HOTWORD", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to capture audio for hotword detection. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission INTERACT_ACROSS_USERS_FULL = new Permission("android.permission.INTERACT_ACROSS_USERS_FULL", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nFuller form of {android.Manifest.permission#INTERACT_ACROSS_USERS} that removes restrictions on where broadcasts can be sent and allows other types of interactions.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission REMOVE_TASKS = new Permission("android.permission.REMOVE_TASKS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to change to remove/kill tasks", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_MTP = new Permission("android.permission.ACCESS_MTP", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to access the MTP USB kernel driver. For use only by the device side MTP implementation.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission HDMI_CEC = new Permission("android.permission.HDMI_CEC", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows HDMI-CEC service to access device and configuration files. This should only be used by HDMI-CEC service.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BROADCAST_SCORE_NETWORKS = new Permission("android.permission.BROADCAST_SCORE_NETWORKS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to broadcast a SCORE_NETWORKS request. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_CONNECTION_SERVICE = new Permission("android.permission.BIND_CONNECTION_SERVICE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to bind to ConnectionService implementations.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_CONDITION_PROVIDER_SERVICE = new Permission("android.permission.BIND_CONDITION_PROVIDER_SERVICE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nMust be required by a {android.service.notification.ConditionProviderService}, to ensure that only the system can bind to it.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission READ_DREAM_STATE = new Permission("android.permission.READ_DREAM_STATE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows applications to read dream settings and dream state.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission USER_ACTIVITY = new Permission("android.permission.USER_ACTIVITY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows access to the PowerManager.userActivity function. <p>Not for use by third-party applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_PRINT_SPOOLER_SERVICE = new Permission("android.permission.BIND_PRINT_SPOOLER_SERVICE", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nMust be required by the PrintSpooler to ensure that only the system can bind to it.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_CA_CERTIFICATES = new Permission("android.permission.MANAGE_CA_CERTIFICATES", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to install and/or uninstall CA certificates on behalf of the user.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission MANAGE_NETWORK_POLICY = new Permission("android.permission.MANAGE_NETWORK_POLICY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to manage network policies (such as warning and disable limits) and to define application-specific rules.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission NET_ADMIN = new Permission("android.permission.NET_ADMIN", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows access to configure network interfaces, configure/use IPSec, etc.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission FREEZE_SCREEN = new Permission("android.permission.FREEZE_SCREEN", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows the application to temporarily freeze the screen for a full-screen transition.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission REAL_GET_TASKS = new Permission("android.permission.REAL_GET_TASKS", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nNew version of GET_TASKS that apps can request, since GET_TASKS doesn't really give access to task information. We need this new one because there are many existing apps that use add libraries and such that have validation code to ensure the app has requested the GET_TASKS permission by seeing if it has been granted the permission... if it hasn't, it kills the app with a message about being upset. So we need to have it continue to look like the app is getting that permission, even though it will never be checked, and new privileged apps can now request this one for real access.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission SET_INPUT_CALIBRATION = new Permission("android.permission.SET_INPUT_CALIBRATION", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows low-level access to setting input device calibration. <p>Not for use by normal applications.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission TEMPORARY_ENABLE_ACCESSIBILITY = new Permission("android.permission.TEMPORARY_ENABLE_ACCESSIBILITY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows an application to temporary enable accessibility on the device.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission ACCESS_CONTENT_PROVIDERS_EXTERNALLY = new Permission("android.permission.ACCESS_CONTENT_PROVIDERS_EXTERNALLY", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows the holder to access content providers from outside an ApplicationThread. This permission is enforced by the ActivityManagerService on the corresponding APIs, in particular ActivityManagerService#getContentProviderExternal(String) and ActivityManagerService#removeContentProviderExternal(String).", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission LOOP_RADIO = new Permission("android.permission.LOOP_RADIO", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nAllows access to the loop radio (Android@Home mesh network) device.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
	public static final Permission BIND_TRUST_AGENT = new Permission("android.permission.BIND_TRUST_AGENT", -1, -1, "This permission is undocumented, its description has been scraped from the Android source.\nMust be required by an {android.service.trust.TrustAgentService}, to ensure that only the system can bind to it.", "Permission was found in https://raw.githubusercontent.com/android/platform_frameworks_base/master/core/res/AndroidManifest.xml, but not in https://developer.android.com/reference/android/Manifest.permission_group.html.");
