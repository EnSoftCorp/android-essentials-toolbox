...
public class AdapterViewFlipper extends AdapterViewAnimator {
	...
	public AdapterViewFlipper(UniverseManipulator um, Q activities, Element element, File xmlLayoutFile) {
		super(um, activities, element, xmlLayoutFile);
		responders.putAll(AdapterViewFlipper.getAttributeResponders());
	}
