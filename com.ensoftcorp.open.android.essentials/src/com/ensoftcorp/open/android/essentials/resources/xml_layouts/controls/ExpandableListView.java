...
public class ExpandableListView extends ListView {
	...
	public ExpandableListView(UniverseManipulator um, Q activities, Element element, File xmlLayoutFile) {
		super(um, activities, element, xmlLayoutFile);
		responders.putAll(ExpandableListView.getAttributeResponders());
	}
