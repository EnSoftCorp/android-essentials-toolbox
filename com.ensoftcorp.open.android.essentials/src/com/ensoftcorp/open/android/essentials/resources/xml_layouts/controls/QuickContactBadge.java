...
public class QuickContactBadge extends ImageView {
	...
	public QuickContactBadge(UniverseManipulator um, Q activities, Element element, File xmlLayoutFile) {
		super(um, activities, element, xmlLayoutFile);
		responders.putAll(QuickContactBadge.getAttributeResponders());
	}
