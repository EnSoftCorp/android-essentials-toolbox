...
public class AutoCompleteTextView extends EditText {
	...
	public AutoCompleteTextView(UniverseManipulator um, Q activities, Element element, File xmlLayoutFile) {
		super(um, activities, element, xmlLayoutFile);
		responders.putAll(AutoCompleteTextView.getAttributeResponders());
	}
