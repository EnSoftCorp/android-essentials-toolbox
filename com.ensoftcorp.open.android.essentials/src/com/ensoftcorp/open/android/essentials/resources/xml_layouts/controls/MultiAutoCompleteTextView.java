...
public class MultiAutoCompleteTextView extends AutoCompleteTextView {
	...
	public MultiAutoCompleteTextView(UniverseManipulator um, Q activities, Element element, File xmlLayoutFile) {
		super(um, activities, element, xmlLayoutFile);
		responders.putAll(MultiAutoCompleteTextView.getAttributeResponders());
	}
