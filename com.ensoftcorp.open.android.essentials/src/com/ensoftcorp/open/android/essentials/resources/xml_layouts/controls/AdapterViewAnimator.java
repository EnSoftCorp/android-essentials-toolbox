...
public class AdapterViewAnimator extends AdapterView {
	...
	public AdapterViewAnimator(UniverseManipulator um, Q activities, Element element, File xmlLayoutFile) {
		super(um, activities, element, xmlLayoutFile);
		responders.putAll(AdapterViewAnimator.getAttributeResponders());
	}
