...
public class HorizontalScrollView extends FrameLayout {
	...
	public HorizontalScrollView(UniverseManipulator um, Q activities, Element element, File xmlLayoutFile) {
		super(um, activities, element, xmlLayoutFile);
		responders.putAll(HorizontalScrollView.getAttributeResponders());
	}
